function [DATA_sphandle,UART_sphandle, ConfigParameters] = radarSetup16XX(configfile,num_COM_UART,num_COM_DATA)
...
%%%% UART COM PORT:
comPortString = sprintf("COM%d", num_COM_UART);
...
%%%% DATA COM PORT:
comPortString = sprintf("COM%d", num_COM_DATA);
